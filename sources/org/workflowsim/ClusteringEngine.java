...
import org.io.postach.esmaeilmirzaeee.dagsim.clustering.ResourceAwareClustering;
import org.io.postach.esmaeilmirzaeee.dagsim.clustering.clustering.BBOClustering;
...
public final class ClusteringEngine extends SimEntity {
    ...
    protected void processClustering() {
        ...
        switch (params.getClusteringMethod()) {
             ...
             */
            case RESOURCE_AWARE:
                this.engine = new ResourceAwareClustering();
                break;
            /**
             * Bio-geography clustering
             */
            case BBOClustring:
                this.engine = new BBOClustering();
                break;
            /**
        ...
        engine.run();
        int size = engine.getJobList().size();
