...
import org.io.postach.esmaeilmirzaeee.dagsim.clustering.scheduling.FTBWS;
...
public class WorkflowScheduler extends DatacenterBroker {
    ...
    private BaseSchedulingAlgorithm getScheduler(SchedulingAlgorithm name) {
        ...
        switch (name) {
            ...
            case ROUNDROBIN:
                ...
                break;
            case BBO: // BBO Scheduling Algorithm
                algorithm = new BBOSchedulingAlgorithmJava();
                break;
            case FTBWS:
                algorithm = new FTBWS();
                break;
    ...
    protected void processCloudletUpdate(SimEvent ev) {
        ...
        getCloudletList().removeAll(scheduledList); // Not OK
